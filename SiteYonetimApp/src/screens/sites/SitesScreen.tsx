    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.headerCard}>
        ...
        <Text style={styles.headerSubtitle}>
          {mockSites.length} site • {totalStats.apartments} daire • {totalStats.residents} sakin
        </Text>
      </View>
          ...
          >
            <View style={styles.siteHeader}>
              <View style={styles.siteInfo}>
                ...
                >
                  <Building2 size={24} color={currentSite.id === site.id ? '#fff' : '#3B82F6'} />
                </View>
                <View style={styles.siteDetails}>
                  ...
                  <View style={styles.statsRow}>
                    <View style={styles.statItem}>
                      ...
                      <Text style={styles.statText}>{site.totalApartments} daire</Text>
                    </View>
                    <View style={styles.statItem}>
                      <Users size={12} color="#6B7280" />
                      <Text style={styles.statText}>{site.totalResidents} sakin</Text>
                    </View>
                  </View>
                </View>
              </View>
