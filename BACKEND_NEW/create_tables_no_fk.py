...
try:
    ...
    print("\nCreating user_sessions table (without FK for now)...")
    cursor.execute("""
    ...
    print("\nNote: Foreign key constraint skipped due to charset/collation mismatch.")
    print("Application will handle referential integrity.")
